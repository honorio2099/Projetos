...
import random
class Pypet:
  def __init__(self, A = None, nome = '', fome = 0 , saude = 0, idade = 0, idadeR = None, humor = None, lvlUP = 0, qtd = None, x = None, death = None):
  ...
  def checkH(self, humor):
    i = 0
    list = ['Super Alegre!','Feliz','Contente','Triste'] 
    self.__humor = random.choice(list)
    while i == 0:  
